...
<div class="container-fluid" id="form_cadastro">
  ...
  <form id="formCadastro" name="formCadastro" method="post" enctype="multipart/form-data">
    ...
    <div class="container-fluid caixa" id="dadosPessoais">
      <?php ################################################################################################ ?>
...
?>
    ...
    <div class="form-group" style="margin-left:15px;">
      ...
      <div class="controls">
        ...
        <span id="msgFile">Não é permitido enviar arquivo com extensão <b><span id="ext"></span></b>.
          Extensões permitidas: <strong>pdf</strong>, <strong>doc</strong> e <strong>docx</strong>.
        </span>
      </div>
    </div>
</div>
